...
//EnemyBoss * EnemyBoss::CEB_pBOSS = NULL;
...
void EnemyPlane::CreateEnemy()
{
	...
	{		
		...
		/*new EnemyPlane(BOSS);*/
		IfBoss = true;
		/*if (UserPlane::GetScore() > 20)*/
	
	}
	//if (rand() % 10 > 8 && CEP_fLastCreateBomberPlaneTime > 15.0f && !IfBoss&&UserPlane::GetScore() >= 500/**/) 
	//{
	//	for (int i = 0; i < 6; ++i)
	//	{
	//		new EnemyBomberPlane(300, i * 60);
	//		new EnemyBomberPlane(880, i * 60);
	//	}
	//	CEP_fLastCreateBomberPlaneTime = 0.0;
	//}
